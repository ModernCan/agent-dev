...
def visualize_workflow(graph: StateGraph) -> None:
    ...
    try:
        ...
        print("IPython is required for visualization. Install it with 'pip install ipython'.")
...
class CommonSchemas:
    ...
    class ThoughtActionResult(BaseModel):
        ...
        thought: str = Field(description="The reasoning process behind the decision")
    ...
    class PlanSteps(BaseModel):
        ...
        steps: List[str] = Field(description="Sequential steps to accomplish the task")
