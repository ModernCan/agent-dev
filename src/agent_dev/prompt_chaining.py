...
class PromptChain:
    ...
    def improve_joke(self, state: JokeState) -> Dict[str, str]:
        ...
        """
        msg = self.llm.invoke(f"Make this joke funnier by adding wordplay: {state['joke']}")
    ...
    def polish_joke(self, state: JokeState) -> Dict[str, str]:
        ...
        """
        msg = self.llm.invoke(f"Add a surprising twist to this joke: {state['improved_joke']}")
